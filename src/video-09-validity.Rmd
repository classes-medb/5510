...
Your book cites a different standard for establishing validity.

Content refers to the individual items in a composite measure. Can you establish that your items are representative of the concept you are trying to measure.

You start with a list of items based on your own knowledge and experience. You do a literature review to build up the list further. Then a panel of experts would review this list to add other items or to prune items that don't belong. The experts might also look to see if the measure tends to favor or discriminate against certain subgroups.

To be honest, I'm not sure how this differs from the approach suggested in face and content validity earlier.

The response processes are similar to those mentioned earlier, but also include assurances that the respondents aren't just telling you what they think you want to hear and that the responses aren't just a function of good test taking skills.

Internal structure is the use of tools like factor analysis to try to establish homogenous items. Factor analysis helps when you are trying to measure several closely related constructs, because it can (sometimes, and I want to emphasize sometimes) disentangle individual items in your composite measure and place them in their proper place.

Relationships to other variables describes the correlations that you compute under criterion validity and construct validity.

Consequences refers to the effect that the measure has on the person providing the information. I'm not really sure how to apply this approach.
