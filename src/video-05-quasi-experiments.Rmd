...
As the Minnesota Department of Health puts it, you obective should state

[Who] will [what] resulting in [measure] by [when]
...
![First step in drawing a fisbone diagram](../images/draw-fishbone01.png)
...
![Second step in drawing a fisbone diagram](../images/draw-fishbone02.png)

<div class="notes">

Off of the backbone, draw and label major bones: 4 to 7 major categories of causes. A commonly used list of major causes is
...
![First step in drawing a fisbone diagram](../images/draw-fishbone03.png)
...
![Fishbone diagram](../images/fishbone02.png)
...
![Fishbone diagram](../images/fishbone03.jpg)
...
![Fishbone diagram](../images/fishbone04.png)
...
![Example of a Pareto chart](../images/pareto01.png)
...
![Example of a Pareto chart](../images/pareto02.png)
...
![Example of a Pareto chart](../images/pareto03.png)
...
***
`r read_text("hw05", fri[5], char_max=500)`
...
***
`r read_text("discussion05", char_max=500)`
