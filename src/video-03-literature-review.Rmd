...
***
`r read_text("readings03", char_max=char_limit)`
...
***
`r read_text("hw03", fri[3], char_max=char_limit)`

<div class="notes">

There's no official homework this week, but please start thinking about your research problem. Most of the future assignments (including developing a literature review) are dependent on you picking out a research problem that you are interested in.

</div>

***
`r read_text("discussion03", fri[3], char_max=char_limit)`

<div class="notes">

There are several discussion questions. You've done great so far, and this is an important componenet of the research.
