...
What you should comment on is how persuasive a study is. The strength of the evidence depends on a variety of factors. Keep in mind that no single factor, by itself, is strong enough that its presence makes a study definitive or that its absence makes the study worthless.

One exception is that you sometimes have to draw a line in the sand because of space limitations. If you have three studies and only room to talk about one of them, pick the one that is most persuasive, especially if the three studies all reach the same conclusion.

Where the strength of the evidence comes into play is when you need to reconcile conflicting studies. Report both, if one is much more persuasive than the other, run with that study's conclusion.
...
This is an important topic and I hope to talk more about it later in the class.
