...
***
`r read_text("readings04", char_max=500)`

<div class="notes">

I'm departing a bit from your book's format for the next few weeks. There are important issues with respect to blinding, intention to treat, etc. that I want to make sure you cover. Read Chapter 5 anyway, and skim through a few of the suggested readings listed here for more backgound in an area you might want to know a bit more about.
...
![Figure 1. Thirty fish in a big tank](../images/fishy01.png)
...
![Figure 2. First six fish go in the first tank](../images/fishy02.png)
...
![Figure 3. Next six fish go in the second tank](../images/fishy03.png)
...
![Figure 4. Next six fish go in the third tank](../images/fishy04.png)
...
![Figure 3. Next six fish go in the fourth tank](../images/fishy02.png)
...
![Figure 6. Last six fish go in the fifth tank](../images/fishy06.png)
...
![Figure 7. Final result-mortality hishest in first tank](../images/fishy07.png)
