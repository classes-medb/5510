...
There are several possible ways to ask close ended questions. You can ask people to fill in the blank. Strictly speaking this is not a close ended question, but the intent is to get responses from a limited subset. You might ask a person "What is your age?" and leave a blank. You're supposed to fill in a number, but some people will fill in something else like "older than dirt". Another example: "What's the one word that describes your greatest weakness? Inability to follow directions."

In some cases, fill in the blank works just fine, but always watch out for unexpected responses.

An ordinal response is a response where the order of the choices has meaning.
