...
* $P\Big[\bar{X}_1-\bar{X}_2>t \times se \ | \ \mu_1-\mu_2=0 \Big]$
...
![Interval that contains the null value](../images/11/ci01.gif)
...
![Interval entirely above the null value](../images/11/ci02.gif)
...
![Interval entirely below the null value](../images/11/ci03.gif)
...
![Interval entirely inside the range of clinical indifference](../images/11/ci04.gif)
...
![Interval partly inside/outside range of clinical indifference](../images/11/ci05.gif)
...
![Confidence interval that contains the null value](../images/11/ci06.gif)
...
![Confidence interval entirely outside the range of clinical indifference](../images/11/ci07.gif)
...
### Saturation
  ...
  + the point at which you are not gaining any new insight, no new categories being identified, no new relationships being defined
