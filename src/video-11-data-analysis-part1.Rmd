...
If your variable has units of measurement, here is where you specify grams, kilograms, or pounds. If there are special qualifiers, like blood pressure measured on the leg instead of the arm, here is where you put those details.
...
There are a variety of ways to code dates, but you should always use the ISO 8601 standard, which is the four digit year followed by a dash. Then you have two digits for the month. It is always two digits, so January is 01 rather than 1 and September is 09 rather than 9. This is followed by another dash and then the two digit day. Note that the first day of the month is 01 rather than 1.

Nobody follows this standard. Sometimes they use slashes rather than dashes. Sometimes they change the order. In America, we put the month, followed by the day, followed by the year. In Europe, they put the day followed by the month, followed by the year. Sometimes you will see the month spelled out or with a three letter abbreviation.

Sometimes they only use two digits for the year. This is a big problem and it leads to little kids being classified as 101 years old.
...
Everything in the computer is stored as a number. That includes dates. Every system has a different way of calculating dates. This can sometimes lead to problems when you switch from one program to another.
...
if the date of October 14, 1582 seems strange to you, it represents the start of the Gregorian calendar.
...
Some people use text strings to designate categorical data. This requires more typing, which may not be too serious a concern, but it also raises the possibility of ambiguity, especially if several people are responsible for data entry.
...
Your book recommends number codes, and I agree with them. But you should know that others hate number codes and prefer the use of strings or single letter codes.
