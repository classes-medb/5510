...
In a probability sample, every person in the population has a known non-zero probability of being in the sample. 
...
This shows the random sampling process using Microsoft Excel. There are 26 patients in your sampling frame. Arrange them in a systematic order. Then attach a column of random numbers. Notice that the smallest random number (0.0138863) is associated with "T". This letter goes to the top of the list when you sort the data and is the first person in your sample.
...
This shows the stratified random sampling process using Microsoft Excel.
...
This table, from the Wheelock artice in recommended readings, shows an example of a purposive sample. In each country, researchers had to select 20 patients and they had to make sure that some of these patients had and some did not have the eligible chronic condition. They also had to get a minimum number from particular demographic groups like gender, age, socioeconomic status, and vaccination status.
...
This shows the randomized allocation of treatments using Microsoft Excel.
...
![A spreadsheet illustrating the process of matching patients on age and gender](../images/08/matching.png)

<div class="notes">

Here's a simplistic example of matching, done by hand inside an Excel spreadsheet.

For this exercise, assume that matched pairs MUST be the same gender, and that you would be okay with an age difference of 6 years or less.

First, pick out the pairs that are a perfect match. There are two perfect matches in this data set: the pair of 8 year old males and the pair of 15 year old males.

Next, look for the smallest discrepancy: one year. If you weren't so fussy about gender, it might make sense to match the 6 year old female with the 7 year old male, but we'll resist that temptation.

Now look for discrepancies of two years. We can match the females who are 4 and 6 years old, the females who are 24 and 26 years old, and the males who 28 and 30 years old.

For discrepancies of three years, you can match the 35 and 38 year old females and the 32 and 35 year old males.

For discrepancies of four years, you can match the 11 and 15 year old females and the 18 and 22 year old males.

You should probably stop here, but if you are willing to match within a six year range, there are a couple more that you can add to the list. At the end of it all, you have a 28 year old female, a 65 year old female, and a 62 year old male who remain unmatched.

The process I described is called a greedy match, and it usually does okay, but sometimes you can improve on it a bit.
