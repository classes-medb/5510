...
Recall bias, though, is unlikely to be stronger in patients with a greater exposure, so if you see a gradient, with low exposures showing smaller effects than large exposures, that's good news. You can rule out recall bias and selection bias and other biases that affect your comparison more or less uniformly across the spectrum of exposures.
