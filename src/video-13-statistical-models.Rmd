...
![Pie chart with three dimensions and exploding wedges](../images/13/piechart02.jpg)

<div class="notes">

This image was found on Wikimedia Commons and has is licensed under the creative commons share alike license. It is available at https://commons.wikimedia.org/wiki/File:Atmospheric_air_components_percentage.jpg
...
![Crosstabulation of gender and mortality on the Titanic](../13/images/titanic01.gif)
...
![Logistic output for the Titanic data](../13/titanic02.gif)
...
If the curve is not very steep and extends in the the 
...
+ Parametric statistics – assumptions
	...
	+ Variances of the groups are equal (homogeneity of variance)
		+ Unequal group sizes and unequal variances lead to increased Type I errors
